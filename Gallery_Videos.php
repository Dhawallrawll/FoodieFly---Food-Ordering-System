                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">View Videos</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="Gallery_ADDVideos.php" class="btn btn-rounded btn-info"><span class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i>
                                    </span>Add Videos</a>
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_videos where Video_id ='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $result = mysqli_query($conn,"select * from tbl_videos") or die(mysqli_error($conn));
                                            $count=1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-id="<?php echo $row["Video_id"]; ?>" data-toggle="modal" data-target="#basicModal" type="button" class="btn btn-rounded btn-danger btn-sm open-delete"><span class="btn-icon-left text-danger"><i class="fa fa-trash color-danger"></i>
                                                        </span>Delete</button>
                                                    <button onclick="window.location='Update_Gallery_ADDVideos.php?id=<?php echo $row["Video_id"]; ?>';" type="button" class="btn btn-rounded btn-primary btn-sm"><span class="btn-icon-left text-danger"><i class="fa fa-pencil color-danger"></i>
                                                        </span>Edit</button>
                                                </td>
                                            </tr>
                                            <?php } ?>
