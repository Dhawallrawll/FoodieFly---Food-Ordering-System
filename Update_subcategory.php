                                ...
                                <div class="basic-form">
                                   ...
                                   <?php
                                    if(isset($_POST["subbtn"]))
                                    {
                                        ...
                                        $result = mysqli_query($conn,"update tbl_subcategory set subcat_name='".$_POST["ssubcat_name"]."',img='".$newname."',cat_id='".$_POST["txtcatid"]."' where subcat_id='".$_GET["id"]."'") or die(mysqli_error($conn));
                                    ...
                                    <?php
                                    $id=$_GET["id"];
                                    $resultupdate = mysqli_query($conn,"select s.*,c.cat_name from tbl_subcategory as s left join tbl_category as c on c.cat_id=s.cat_id where s.subcat_id='".$_GET["id"]."'") or die(mysqli_error($conn));
                                            $count=1;
                                    ...
                                    <form method="post" enctype="multipart/form-data" id="subcat-form">
                                          <div class="form-group row">
                                            ...
                                            ?>
                                                    ...
                                                    <option <?php if($row["cat_id"]==$rowupdate["cat_id"]) {?> selected <?php } ?> value="<?php echo $row["cat_id"];?>"><?php echo $row["cat_name"]; ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="<?php echo $rowupdate["subcat_name"]; ?>" name="ssubcat_name" type="text" class="form-control" placeholder="Sub Category">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <a href="uploads/sub_category/<?php echo $rowupdate["img"]; ?>" target="_blank"><img src="uploads/sub_category/<?php echo $rowupdate["img"]; ?>" width="100" height="100"/></a>
                                                <input type="hidden" name="oldimage" value="<?php echo $rowupdate["img"]; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button name="subbtn" type="submit" class="btn btn-primary float-right">Update</button>
                                            </div>
                                        </div>
                                    </form>
