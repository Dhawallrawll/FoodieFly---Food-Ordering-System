                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">View Booking</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_table_book where book_id  ='".$_POST["deleteid"]."'");
                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $result = mysqli_query($conn,"select * from tbl_table_book") or die(mysqli_error($conn));
                                            $count=1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-id="<?php echo $row["book_id"]; ?>" data-toggle="modal" data-target="#basicModal" type="button" class="btn btn-rounded btn-danger btn-sm open-delete"><span class="btn-icon-left text-danger"><i class="fa fa-trash color-danger"></i>
                                                        </span>Delete</button>
