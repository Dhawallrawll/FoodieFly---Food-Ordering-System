                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">List of Category</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="Addcategory.php" class="btn btn-rounded btn-info"><span class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i>
                                    </span>Add Category</a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_category where cat_id='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="uploads/category/<?php echo $row["cat_image"]; ?>" target="_blank"><img src="uploads/category/<?php echo $row["cat_image"]; ?>" width="100" height="100"/></a></td>
                                                <td>
                                                    <button data-id="<?php echo $row["cat_id"]; ?>" data-toggle="modal" data-target="#basicModal" type="button" class="btn btn-rounded btn-danger btn-sm open-delete"><span class="btn-icon-left text-danger"><i class="fa fa-trash color-danger"></i>
                                                        </span>Delete</button>


                                                    <button onclick="window.location='Update_category.php?id=<?php echo $row["cat_id"]; ?>';"  type="button" class="btn btn-rounded btn-primary btn-sm"><span class="btn-icon-left text-danger"><i class="fa fa-pencil color-danger"></i>
                                                        </span>Edit</button>
                                                </td>
                                            </tr>
                                           <?php } ?>
