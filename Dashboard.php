...
<!-- Mirrored from koki.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Nov 2020 08:04:04 GMT -->
<head>
    <meta charset="utf-8">
				...
				<div class="row">
						...
						<div class="card overflow-hidden">
							<div class="card-header media border-0 pb-0">
								<div class="media-body">
									<h2 class="text-black"><?php $sql="select * from tbl_subcategory";
					...
					<div class="col-xl-3 col-lg-3 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header media border-0 pb-0">
								<div class="media-body">
									<h2 class="text-black"><?php $sql="select * from tbl_order";
												$result=mysqli_query($conn,$sql); 
													$rws=mysqli_num_rows($result);
					...
					<div class="col-xl-3 col-lg-3 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header media border-0 pb-0">
								<div class="media-body">
									<h2 class="text-black"><?php $sql="select * from tbl_user";
												$result=mysqli_query($conn,$sql); 
													$rws=mysqli_num_rows($result);
							...
							<div class="card-header media border-0 pb-0">
								<div class="media-body">
									<h2 class="text-black">₹<?php 
                                        $result = mysqli_query($conn, 'SELECT SUM(total_price) AS value_sum FROM tbl_order'); 
							...
							<div class="card-header border-0">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="javascript:;">2023</a>
...
$sql = "SELECT u.user_name, o.image, o.title, o.address, o.qty, o.price, o.order_status
FROM tbl_user u
INNER JOIN tbl_order o ON u.user_id = o.user_id";
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="mr-3 img-fluid rounded-circle" width="75"  src="../admin/uploads/menu/<?php echo $row["image"]; ?>" alt="product">
													<div class="media-body">
														<h5 class="mt-0 mb-2"><a class="text-black" href="ecom-product-detail.html"><?php echo $row["title"];?></a></h5>
														<p class="mb-0 text-primary">#0010235</p>
													</div>
												</div>
											</td>
											<td>
												<h5 class="mb-2 text-black wspace-no"><?php echo $row["user_name"]?></h5>
												<p class="mb-0"><?php echo $row["address"]?></p>
											</td>
											<td style="width:100px;">
												<div class="d-flex align-items-center justify-content-center">
													<h4 class="mb-0 mr-3 fs-20 text-black d-inline-block">₹<?php echo $row["price"]?></h4>
													<p class="mb-0 fs-20 d-inline-block">x<?php echo $row["qty"]?></p>
											...
											<td>
												<div class="d-flex align-items-center">
													<a class="btn bgl-warning text-warning" href="javascript:;"><?php echo $row["order_status"]?></a>
...
<!-- Mirrored from koki.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Nov 2020 08:04:05 GMT -->
</html>