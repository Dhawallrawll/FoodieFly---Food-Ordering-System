                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                	...
                                	if(isset($_POST["btnadd"]))
                                	{
                                		...
                                		$result = mysqli_query($conn,"insert into tbl_category (cat_name,cat_image) values ('".$_POST["txtcatname"]."','".$newname."')") or die(mysqli_error($conn));
                                		if($result==true)
                                		{
                                			?>
                                    ...
                                    <form method="post" enctype="multipart/form-data" id="cat-form">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="txtcatname" type="text" class="form-control" placeholder="Category Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button name="btnadd" type="submit" class="btn btn-primary float-right">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
