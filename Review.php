                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">View Review</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List of Review</h4>
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_review where Review_id ='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-id="<?php echo $row["review_id"]; ?>" data-toggle="modal" data-target="#basicModal" type="button" class="btn btn-rounded btn-danger btn-sm open-delete" ><span class="btn-icon-left text-danger"><i class="fa fa-trash color-danger"></i>
                                                        </span>Delete</button>
