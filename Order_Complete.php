                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                             ...
                                             WHERE tbl_order.order_status like '%complete%'";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button onclick="window.location='reciept.php?id=<?php echo $row["order_id"]; ?>';" type="button" class="btn btn-rounded btn-primary btn-sm"><span class="btn-icon-left text-danger"><i class="fa fa-pencil color-danger"></i>
                                                        </span>Get Reciept</button>
                                                </td>
                                            </tr>
