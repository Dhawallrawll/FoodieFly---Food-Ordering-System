                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span>List of Pending Orders</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">View Pending Orders</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">List of Pending Orders</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_order where order_id='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                             ...
                                             WHERE tbl_order.order_status like '%pending%'";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-id="<?php echo $row["order_id"]; ?>" data-toggle="modal" data-target="#basicModal" type="button" class="btn btn-rounded btn-danger btn-sm open-delete" ><span class="btn-icon-left text-danger"><i class="fa fa-trash color-danger"></i>
                                                        </span>Delete</button>
                                                    <button onclick="window.location='Status_update.php?id=<?php echo $row["order_id"]; ?>';" type="button" class="btn btn-rounded btn-primary btn-sm"><span class="btn-icon-left text-danger"><i class="fa fa-pencil color-danger"></i>
                                                        </span>Edit</button>
                                                </td>
                                            </tr>
